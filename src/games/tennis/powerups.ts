...
export const POWER_UP_CONFIGS: { [key in PowerUpType]: PowerUpConfig } = {
  ...
  power_smash: {
    ...
    color: '#e74c3c',
    duration: 8,
    description: 'Next shots are super powerful',
    rarity: 0.25,
  },
  auto_aim: {
    type: 'auto_aim',
    ...
    color: '#2ecc71',
    duration: 6,
    description: 'Ball automatically targets gaps',
    rarity: 0.15,
  },
  speed_boost: {
    type: 'speed_boost',
    ...
    color: '#f1c40f',
    duration: 7,
    description: 'Move faster across the court',
    rarity: 0.3,
  },
  multi_hit: {
    type: 'multi_hit',
    ...
    color: '#9b59b6',
    duration: 5,
    description: 'Ball splits into multiple trajectories',
    rarity: 0.1,
  },
};
