...
import GalaxyRiderGame from './games/galaxy-rider/GalaxyRiderGame';
...
import FruitNinjaGame from "./games/fruit-ninja/FruitNinjaGame";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/game/fruit-ninja" element={<FruitNinjaGame />} />
